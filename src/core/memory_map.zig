...
pub const INTERRUPT_ROUTINE_SIZE = INTERRUPT_ROUTINE_END - INTERRUPT_ROUTINE_START + 1;

pub const SYSCALL_ROUTINE_START = 0x0004_1000;
pub const SYSCALL_ROUTINE_END = 0x0008_0FFF;
pub const SYSCALL_ROUTINE_SIZE = SYSCALL_ROUTINE_END - SYSCALL_ROUTINE_START + 1;

pub const BIOS_SECTOR_START = 0x0000_1000;
pub const BIOS_SECTOR_END = 0x0000_1FFF;
pub const BIOS_SECTOR_SIZE = BIOS_SECTOR_END - BIOS_SECTOR_START + 1;

// 16MB Instruction Memory
pub const INSTR_MEM_SECTOR_START = 0x1000_0000;
pub const INSTR_MEM_SECTOR_END = 0x1FFF_FFFF;
pub const INSTR_MEM_SECTOR_SIZE = INSTR_MEM_SECTOR_END - INSTR_MEM_SECTOR_START + 1;

// 16MB Data Memory
pub const DATA_MEM_SECTOR_START = 0x2000_0000;
pub const DATA_MEM_SECTOR_END = 0x2FFF_FFFF;
pub const DATA_MEM_SECTOR_SIZE = DATA_MEM_SECTOR_END - DATA_MEM_SECTOR_START + 1;
